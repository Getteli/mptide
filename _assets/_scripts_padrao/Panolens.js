...
GSVPANO.PanoLoader = function (parameters) {
    ...
    /**
     * Data Image Source
     * https://pchen66.github.io/Panolens/asset/icon/
     * @type {String}
     */
    PANOLENS.DataImageSource = '_assets/_img/';
    ...
    PANOLENS.DataImage = {
    	// informacao
        Info:               PANOLENS.DataImageSource + 'pinI.png',
        Video:              PANOLENS.DataImageSource + 'pinV.png',
        Foto:               PANOLENS.DataImageSource + 'pinF.png',
        Audio:              PANOLENS.DataImageSource + 'pinA.png',
        // setas
        SetaCima:           PANOLENS.DataImageSource + 'seta-cima.png',
        SetaDiaCimaDir:     PANOLENS.DataImageSource + 'seta-dia-cima-dir.png',
        SetaDir:            PANOLENS.DataImageSource + 'seta-dir.png',
        SetaDiaBaixoDir:    PANOLENS.DataImageSource + 'seta-dia-baixo-dir.png',
        SetaBaixo:          PANOLENS.DataImageSource + 'seta-baixo.png',
        SetaDiaBaixoEsq:    PANOLENS.DataImageSource + 'seta-dia-baixo-esq.png',
        SetaEsq:            PANOLENS.DataImageSource + 'seta-esq.png',
        SetaDiaCimaEsq:     PANOLENS.DataImageSource + 'seta-dia-cima-esq.png',
...
PANOLENS.StereographicShader = {
	...
	PANOLENS.Panorama.prototype.mptide_function_js_tooltip_showoff = function ( text, in_ou ) {
		...
		if (in_ou == "saiu") {
			...
			mptide_tooltipSpan_in_out.fadeOut(50);
	 ...
	 */
	PANOLENS.Panorama.prototype.link = function ( pano, position, imageScale, imageSrc, text_vem ) {
		...
		if ( imageSrc ) {
			...
			img = PANOLENS.DataImage.SetaCima;
		...
		spot.addEventListener("hoverenter", function(){
			mptide_function_js_tooltip_showoff(text_vem, "entrou");
			// criar por mim Douglas, se passar pela seta, verifica se esta nulo, se nao vibra
			if (mptide_vmacess != null) {
				$("#mptide_tooltip_span").click();
				$("#mptide_tooltip_span").vibrate(); // ao passar por cima vibra
			}
		});
		spot.addEventListener("hoverleave", function(){
			mptide_function_js_tooltip_showoff(text_vem, "saiu");
		});
        spot.addEventListener( 'click', function () {
        	// criar por mim Douglas
			if (mptide_vmacess != null) {
				$("#mptide_tooltip_span").click();
	...
	*/
	...
	PANOLENS.Infospot.prototype.addHoverText = function ( text, delta ) {
		...
		if ( !this.element ) {
			...
			this.element.style.fontFamily = '"Montserrat", sans-serif';
	...
	PANOLENS.Viewer.prototype.addViewIndicator = function () {
		...
		function loadViewIndicator ( asyncEvent ) {
			...
			viewIndicatorDiv.id = "mptide_view_indicator_container";
